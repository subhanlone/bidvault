...
export default function BuyerProfile() {
  ...
  const quickLinks = [
    { label: 'Browse Auctions', to: '/buyer/browse', icon: <Search size={15} className="text-[#6c757d]" /> },
    { label: 'My Bids', to: '/buyer/my-bids', icon: <Hammer size={15} className="text-[#6c757d]" /> },
    { label: 'My Watchlist', to: '/buyer/watchlist', icon: <Heart size={15} className="text-[#6c757d]" /> },
  ];
        ...
        <div className="bg-[#0b1f3a] relative overflow-hidden">
          ...
          <div className="max-w-[900px] mx-auto px-4 sm:px-6 py-8 sm:py-10 relative z-10">
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              <button
                onClick={logout}
                className="shrink-0 border border-[rgba(255,255,255,0.18)] font-semibold text-[13px] text-[rgba(255,255,255,0.6)] px-4 py-2 rounded-[8px] hover:border-[#d0021b] hover:text-[#ff6b7a] transition-colors cursor-pointer"
              >
                Sign Out
              </button>
            </div>
                  ...
                  <div className="flex flex-col divide-y divide-[#f8f9fa]">
                    {myBids.slice(0, 5).map(bid => {
                      ...
                      return (
                        <button
                          key={bid.bidId}
                          className="flex items-center gap-3 px-5 py-3 hover:bg-[#f8f9fa] transition-colors text-left w-full cursor-pointer"
                ...
                <div className="p-5">
                  {!showPwForm ? (
                    <button
                      ...
                      className="w-full border border-[#dee2e6] font-semibold text-[13px] text-[#495057] py-2.5 rounded-[8px] hover:bg-[#f8f9fa] hover:border-[#d0021b] hover:text-[#d0021b] transition-colors cursor-pointer"
                    >
                      Change Password
                    </button>
                  ) : (
                    <div className="flex flex-col gap-3">
                      ...
                      <div className="relative">
                        ...
                        />
                        <button type="button" aria-label={showPw ? 'Hide password' : 'Show password'} onClick={() => setShowPw(v => !v)} className="absolute right-3 top-[10px] text-[#adb5bd] cursor-pointer">
                      ...
                      <div className="flex gap-2">
                        <button
                          ...
                          className="flex-1 border border-[#dee2e6] font-semibold text-[12px] text-[#6c757d] py-2 rounded-[8px] hover:bg-[#f8f9fa] cursor-pointer"
                        >
                          Cancel
                        </button>
                        <button
                          onClick={() => { setShowPwForm(false); setNewPw(''); }}
                          className="flex-1 bg-[#d0021b] font-bold text-[12px] text-white py-2 rounded-[8px] hover:bg-[#a80016] cursor-pointer"
                        >
                          Save
                        </button>
                      </div>
