            ...
            {auction && (
              <>
                ...
                <div className="flex gap-3">
                  <button
                    onClick={() => navigate(-1)}
                    className="flex-1 border border-[#dee2e6] font-semibold text-[14px] text-[#495057] py-3 rounded-[8px] hover:bg-[#f8f9fa] transition-colors cursor-pointer"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    disabled={loading}
                    className="flex-1 bg-[#d0021b] font-bold text-[14px] text-white py-3 rounded-[8px] hover:bg-[#a80016] transition-colors disabled:opacity-60 shadow-[0_4px_12px_rgba(208,2,27,0.25)] cursor-pointer"
                  >
                    {loading
